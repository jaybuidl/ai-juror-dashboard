...
function provenanceOf({ roster, disputes, performance }: MatrixPageProps): Provenance {
  ...
  caveats.push(
    "Commit latency, per-agent-juror summaries, rewards and the court's historical period durations have not been read at all.",
  );
  ...
  return (
    <View provenance={provenanceOf(props)}>
      ...
      <Caveat role="status">
        {measured ? (
          <>
            <CaveatTitle>Two measures, and what is missing from them</CaveatTitle>
            <CaveatBody>
              This page measures how long each agent juror took to reveal its vote, and whether that
              vote matched the dispute's final ruling. It measures nothing else yet: commit latency,
              per-agent-juror summaries and rewards have not been read, and no figure here is a
          ...
          <>
            ...
            <CaveatBody>
              This page measures how long each agent juror took to reveal its vote and whether that
              vote matched the dispute's final ruling — but not on this load: what it needed could
              not be read, and it shows what it did read rather than a matrix built from part of it.
              Nothing below is a latency, a coherence or a draw.
            </CaveatBody>
          </>
        )}
      </Caveat>
